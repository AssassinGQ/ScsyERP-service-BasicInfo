...
## 权限的初始化数据
insert into t_project(corporation, name, project_number, customer, manufacturer, consignee, admin) values (1, "project_1", "xm1", 1, 1, 1, 1);
insert into t_project(corporation, name, project_number, customer, manufacturer, consignee, admin) values (1, "project_2", "xm1", 1, 1, 1, 1);