...
## 权限的初始化数据
insert into t_truck(corporation, name, phone, car_number) values (1, "truck_1", 18811111111, "C1234");
insert into t_truck(corporation, name, phone, car_number) values (1, "truck_2", 18811111111, "A1234");