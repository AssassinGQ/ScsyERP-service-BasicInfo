...
## 权限的初始化数据
insert into t_workshop(corporation, name, phone, address, manufacturer) values (1, "workshop_1", 18811111111, "shaoxing", 1);
insert into t_workshop(corporation, name, phone, address, manufacturer) values (1, "workshop_2", 18811111111, "wuhan", 1);